    ...
    return(
        ...
        <div className="container-contrato">
            <div className="qualidades-container">
                ...
                <h3>A Pulse Talents irá garantir qualidade e comprometimento, para que seu evento seja inesquecível veja como abaixo:</h3>
                </div>

                <div className="box-container">

                <div className="qualidade"><img id="fto" src={Ft1}/><span>Temos os melhores e mais qualificados artistas que sabem exatamente como animar uma multidão e criar a atmosfera perfeita para cada evento.</span></div>
